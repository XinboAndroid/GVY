...
class MatsonAncFtpAdaptor extends AbstractExtensionCallback {
  ...
  public boolean sendDocument(String inFileName, InputStream inInputStream) throws BizFailure {
    ...
    try {
      LOGGER.info("Current Directory : "+_ftpClient.printWorkingDirectory());
      if(_ftpClient.printWorkingDirectory()!=null && !("/"+userId+"/"+communicationFolder).equals(_ftpClient.printWorkingDirectory())) {
