...
private Logger LOGGER = Logger.getLogger(MatsonAncUnitEquipmentLibrary.class);
  public void execute(Map inParam) {
    ...
    /*looks the empty is part of
    2016-08-22 01:44:10,191 INFO   [ajp-bio-9584-exec-42255            ] [MatsonAncUnitEquipmentInterceptor:?] (244163026) BL NUMBER DISAPPEARED : MatsonAncUnitEquipmen
    tInterceptor param[ORIGINAL_FIELD_CHANGES:FieldChanges(2)
            -ueAttachTime = 'null' => 'Mon Aug 22 01:44:10 PDT 2016'
            -ueArrivalOrderItem = 'null' => 'EquipmentOrderItem:18138923'*/
