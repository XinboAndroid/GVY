 ...
 */
class MATUnitRollBookingUpdateExt2 extends AbstractGeneralNoticeCodeExtension{
    ...
    public void execute(GroovyEvent inEvent) {
        ...
        /**
         ...
         this.log("Booking Nbr for Event  ---:"+thisEvent.getEventTypeId()+ " Booking Nbr :"+bookingNbr)
